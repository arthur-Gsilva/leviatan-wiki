...
export const poneglyphs: Poneglyph[] = [
    ...
    },
    {
        ...
        context: "Gravado nas costas do próprio Zunesha, descoberto durante a passagem do bando pela ilha elefante. O texto vibrava com uma frequência estranha que apenas os Minks conseguiam sentir.",
